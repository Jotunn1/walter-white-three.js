...
let world, walter;
let hemiLight, dirLight, backLight, isUp, frrrr, isMove;
...
function Walter() {
    ...
    //head
    let head = new THREE.BoxGeometry(300, 350, 280);
    ...
    //glasses
    let glass = new THREE.BoxGeometry(120, 78, 10);
    //Retinas Left
    ...
    //glass middle
    let glassu = new THREE.BoxGeometry(40, 10, 10);
    //Retinas Left
    ...
    //Retinas
    let retina = new THREE.BoxGeometry(25, 25, 5);
    //Retinas Left
    ...
    //beard
    let beard = new THREE.BoxGeometry(140, 130, 10);
    ...
    //mout
    let mout = new THREE.BoxGeometry(90, 60, 50);
    ...
    //lip
    let lip = new THREE.BoxGeometry(40, 20, 50);
    ...
    let body = new THREE.BoxGeometry(300, 250, 600);
    ...
    let arm = new THREE.BoxGeometry(50, 250, 100);
    ...
    let hand = new THREE.BoxGeometry(50, 50, 50);
    ...
    let zipper = new THREE.BoxGeometry(80, 250, 10);
    ...
    let legs = new THREE.BoxGeometry(200, 300, 300);
    ...
    let legsM = new THREE.BoxGeometry(10, 130, 5);
    ...
    let shoes = new THREE.BoxGeometry(200, 50, 400);
